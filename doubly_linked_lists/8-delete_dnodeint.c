...
/**
  * delete_dnodeint_at_index - Functio that erase a node where you specifed
  * @head: the first node
  * @index: the integuer number that represents the position
  *
  * Return: 1 if it is done, and -1 if the element do not exist
  */
